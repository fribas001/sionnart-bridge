...
\- `sionnart\_example\_city\_scene.blend` — complete example scene containing

&#x20; the city environment, devices, simulation settings, imported results,

&#x20; Geometry Nodes visualization, camera, materials, and animation.
...
4\. Open `sionnart\_example\_city\_scene.blend`.
...
configuration used to create the displayed result. Configure a compatible

external Sionna RT Python environment before running the simulation again.



Re-execution time and numerical output can depend on the selected Mitsuba

backend, GPU, driver, and hardware.
